...
public class DeleteMatricula extends javax.swing.JFrame {

    /**
     * Creates new form MatriculaVentana
     */
    public DeleteMatricula() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteMatricula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteMatricula().setVisible(true);
            }
        });
    }
