...
public class UpdateAuto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Marca Vehiculo");

        jLabel3.setText("Precio Vehiculo");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Placa", "Marca", "Precio", "Kilometraje", "Modelo"
            }
        ) {
 ...
 private void actualizarTable1(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateAuto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateAuto().setVisible(true);
            }
        });
    }
